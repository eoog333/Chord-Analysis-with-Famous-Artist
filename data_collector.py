...
def run_collection(target_artists: list[str], output_path: str = OUTPUT_CSV) -> pd.DataFrame:
    ...
    if not df.empty:
        ...
        df["relative_chords"] = df["relative_chords"].fillna("1 5 6 4")
